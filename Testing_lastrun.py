...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\19728\\OneDrive\\Documents\\Testing_lastrun.py',
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/19728/OneDrive/Documents/ImageTesting.xlsx'),
...
for thisTrial in trials:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    imagetest.setImage(Images)
    key_resp.keys = []
    key_resp.rt = []
    _key_resp_allKeys = []
    # keep track of which components have finished
    trialComponents = [imagetest, key_resp]
    ...
    while continueRoutine:
        ...
        if imagetest.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > imagetest.tStartRefresh + 5.0-frameTolerance:
                # keep track of stop time/frame for later
